...
// Placeholder
$placeholder = apply_filters( 'codeless_search_form_placeholder', esc_html__( 'Search', 'folie' ) );
$unique_id = esc_attr( uniqid( 'search-form-' ) ); ?>

<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label for="<?php echo esc_attr( $unique_id ); ?>">
		<span class="screen-reader-text"><?php echo _x( 'Search for:', 'label', 'folie' ); ?></span>
	</label>
