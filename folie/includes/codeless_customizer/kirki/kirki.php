...
include_once( CODELESS_KIRKI_BASE . DIRECTORY_SEPARATOR . 'autoloader.php' );
...
Kirki::$path = wp_normalize_path( CODELESS_KIRKI_BASE );
...
include_once wp_normalize_path( CODELESS_KIRKI_BASE . '/includes/deprecated.php' );

// Include the ariColor library
include_once wp_normalize_path( CODELESS_KIRKI_BASE . '/includes/lib/class-aricolor.php' );
