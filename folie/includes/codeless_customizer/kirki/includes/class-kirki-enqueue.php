	...
	class Kirki_Enqueue {
		...
		public function customize_controls_enqueue_scripts() {
			...
			$scripts = array(
				...
				'custom'        => array( 'jquery', 'customize-base' ),
				'cssbox'        => array( 'jquery', 'customize-base', 'serialize-js', 'kirki-validate-css-value' ),
				...
				'clelement'        => array( 'jquery', 'customize-base', 'jquery-ui-core', 'jquery-ui-sortable', 'kirki-validate-css-value', 'serialize-js', 'selectize' ),
				'select'          => array( 'jquery', 'customize-base', 'selectize' ),
				'inlineselect'          => array( 'jquery', 'customize-base', 'selectize' ),
				'slider'          => array( 'jquery', 'customize-base' ),
				'sortable'        => array( 'jquery', 'customize-base', 'jquery-ui-core', 'jquery-ui-sortable', 'serialize-js' ),
				'codelessheader'  => array( 'jquery', 'customize-base', 'jquery-ui-core', 'jquery-ui-sortable', 'jquery-ui-draggable', 'jquery-ui-droppable', 'serialize-js' ),
			...
			//Modified Codeless
			/*wp_enqueue_script( 'cl-controls.min', trailingslashit( Kirki::$url ) . 'assets/js/cl-controls.min.js', array(  'jquery', 
					   	'customize-base', 
					   	'jquery-ui-core', 
					   	'jquery-ui-sortable', 
					   	'jquery-ui-draggable', 
			...
			$default_variants = array(
					array('id' => '100', 'label' => 'Extra Light 100'),
					array('id' => '200', 'label' => 'Light 200'), 
					array('id' => '300', 'label' => 'Book 300'),
					array('id' => '400', 'label' => 'Normal 400'),
					array('id' => '600', 'label' => 'Semi Bold 600'),
					array('id' => '700', 'label' => 'Bold 700'),
					array('id' => '900', 'label' => 'Ultra-Bold 900')
			);
			wp_localize_script( 'kirki-typography', 'kirkiAllFonts', $final );
			wp_localize_script( 'kirki-typography', 'defaultVariants', $default_variants );
			// Modified By Codeless
			wp_localize_script( 'kirki-clelement', 'codelessPalettes', codeless_generate_palettes() );
			/*wp_localize_script( 'cl-controls.min', 'kirkiAllFonts', $final );
			wp_localize_script( 'cl-controls.min', 'defaultVariants', $default_variants );*/
		}
