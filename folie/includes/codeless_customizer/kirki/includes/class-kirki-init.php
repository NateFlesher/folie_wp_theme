...
if ( ! class_exists( 'Kirki_Init' ) ) {
	...
	class Kirki_Init {
		...
		public function set_url() {
			...
			$path = wp_normalize_path(  Kirki::$path );
			...
			Kirki::$url = plugin_dir_url( CODELESS_KIRKI_BASE . '/kirki.php' );
		...
		public function register_control_types() {
			...
			$wp_customize->register_control_type( 'Kirki_Controls_Codelessheader_Control' );
			$wp_customize->register_control_type( 'Kirki_Controls_Cssbox_Control' ); 
			$wp_customize->register_control_type( 'Kirki_Controls_Grouptitle_Control' ); 
			$wp_customize->register_control_type( 'Kirki_Controls_Groupdivider_Control' ); 
			$wp_customize->register_control_type( 'Kirki_Controls_Inlineselect_Control' ); 
		...
		public function add_fields() {
			...
			foreach ( Kirki::$fields as $args ) {
				...
				if ( $wp_customize ) {
					...
					if( isset($_GET['mode']) && $_GET['mode'] == 'simple' && ( ! isset($args['use_on_simple']) || (isset($args['use_on_simple']) && ! $args['use_on_simple'] ) ) )
						continue;
