...
if ( ! class_exists( 'Kirki_Controls_Color_Control' ) ) {
	...
	class Kirki_Controls_Color_Control extends Kirki_Customize_Control {
		 ...
		 *
		 * @access protected Modified by Codeless
		 */
		protected function content_template() {
			...
			<div class="element-wrapper">
				...
				<label>
					...
					<# if(data.inline_control){ #>
						<input type="text" data-palette="{{ data.palette }}" data-default-color="{{ data.default }}" data-alpha="{{ data.choices['alpha'] }}" value="{{ data.value }}" class="kirki-color-control color-picker color-picker-hex" {{{ data.link }}} />
					<# }else{ #>
