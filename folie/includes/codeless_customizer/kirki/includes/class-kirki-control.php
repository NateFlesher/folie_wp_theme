	...
	class Kirki_Control {
		...
		final private function set_control_types() {
			...
			$this->control_types = apply_filters( 'kirki/control_types', array(
				...
				'kirki-cssbox'         => 'Kirki_Controls_Cssbox_Control',
				...
				'clelement'              => 'Kirki_Controls_Clelement_Control',
				...
				'kirki-codelessheader'  => 'Kirki_Controls_Codelessheader_Control',
				'kirki-grouptitle'  => 'Kirki_Controls_Grouptitle_Control',
				'kirki-groupdivider'  => 'Kirki_Controls_Groupdivider_Control',
				'kirki-inlineselect'  => 'Kirki_Controls_Inlineselect_Control'
			) );
