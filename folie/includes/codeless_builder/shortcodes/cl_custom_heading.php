...
if( ($custom_responsive_992_bool || $custom_responsive_768_bool) ): ?>
	...
	<style type="text/css">
		...
		<?php if( $custom_responsive_992_bool ): ?>
			@media (max-width:992px){ #<?php echo esc_attr( $heading_id ) ?>{ font-size:<?php wp_kses_post( $custom_responsive_992_size ) ?> !important; line-height:<?php wp_kses_post( $custom_responsive_992_line_height ) ?> !important; } }
		<?php endif; ?>
