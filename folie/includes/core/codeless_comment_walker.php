				...
				<div class="comment-content post-content" itemprop="text">
					...
					<div class="comment-meta post-meta" role="complementary">
						<div class="comment-author">
							...
							<?php comment_reply_link(array_merge( $args, array('reply_text' => '<span>'.esc_html__('Reply', 'folie' ).'</span>', 'add_below' => $add_below, 'depth' => $depth, 'max_depth' => $args['max_depth']))) ?>
							<?php edit_comment_link( esc_html__('Edit this comment','folie' ),'',''); ?>
						</div>
